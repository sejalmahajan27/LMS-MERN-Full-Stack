...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-12 text-left'>
        <div className='absolute top-0 left-0 w-full h-[600px] -z-10 bg-gradient-to-b from-cyan-100/70'></div>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Sejal-Mahajan</span></p>
        ...
        {/* Right column */}
        <div className='max-w-[550px] z-10 shadow-lg rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
